...
local on_attach = function(_, bufnr)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<F3>", ":lua vim.lsp.buf.format({ async = true })<CR>", opts)
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<F4>", ":lua vim.lsp.buf.code_action()<CR>", opts)
